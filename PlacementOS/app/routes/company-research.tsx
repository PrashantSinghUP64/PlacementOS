  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-16 relative z-20">
        ...
        {/* PROFILE CARD */}
        {company && !loading && (
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden animate-fade-in-up">
            
            {/* Header */}
            <div className="p-8 md:p-10 border-b border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row">
              {/* Sidebar Tabs */}
              <div className="md:w-64 bg-gray-50 dark:bg-gray-950 border-r border-gray-100 dark:border-gray-800 p-4 space-y-2">
                {[
              ...
              <div className="flex-1 p-8 md:p-10 min-h-[400px]">
                ...
                {activeTab === 1 && (
                  <div className="animate-fade-in space-y-8">
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 font-medium leading-relaxed">{company.about}</p>
                    </div>
                    <div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {company.dsaTopics.map(t => (
                            <li key={t} className="flex items-center gap-2 text-sm font-bold text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-950 p-2 rounded-lg border border-gray-100 dark:border-gray-800">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {company.sampleQuestions.map((q, i) => (
                           <div key={i} className="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm relative overflow-hidden group">
                             <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-teal-400 to-indigo-500"></div>
                             <p className="font-bold text-gray-800 dark:text-gray-200 text-[15px] pl-2">{q}</p>
                           </div>
                        ))}
                      </div>
                    </div>
                ...
                {activeTab === 4 && (
                  <div className="animate-fade-in space-y-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm mt-6">
                       <div className="flex items-center gap-4 mb-4 pb-4 border-b border-gray-100 dark:border-gray-800">
                         ...
                         <div>
                           <h4 className="font-black text-gray-900 dark:text-white">Joining Bonus / Sign-on</h4>
                           <p className="text-sm font-bold text-gray-600 dark:text-gray-400">{company.salary.joiningBonus}</p>
                         </div>
                       </div>
                ...
                {activeTab === 6 && (
                  <div className="animate-fade-in relative">
                    ...
                    <div className="mt-8 p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200">
