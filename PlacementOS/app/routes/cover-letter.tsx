  ...
  const handleGenerate = async (isRegenerate = false) => {
    ...
    try {
      if (!window.puter?.ai?.chat) {
        throw new Error("Puter.js AI is not ready. Please try again.");
      }
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6 -mt-16 relative z-20">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-col gap-5">
            <div>
              ...
              <input
                ...
                className="w-full p-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all font-medium"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-32 p-3 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all resize-none text-sm"
              />
            </div>

            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1.5">Your Resume text</label>
              <textarea
                value={resumeText}
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1.5">Writing Tone</label>
                ...
                {TONES.map(t => (
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                      tone === t ? "bg-white text-blue-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
                    }`}
                  >
                    {t}
                  </button>
          ...
          {/* Results View */}
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 flex flex-col min-h-[600px]">
            ...
            {result ? (
              <div className="flex flex-col h-full animate-fade-in">
                ...
                <div className="flex flex-wrap gap-2 mb-4 text-xs font-bold text-gray-500">
                  ...
                  <span className="bg-blue-50 text-blue-700 px-3 py-1.5 rounded-lg">Tone: {tone}</span>
                </div>

                {/* The Letter */}
                <div className="flex-1 bg-gray-50 rounded-xl p-6 border border-gray-100 overflow-y-auto font-serif text-gray-800 leading-relaxed whitespace-pre-wrap shadow-inner text-[15px]">
                  {result}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
                  <button 
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
                      copied ? "bg-green-100 text-green-700 border-green-200" : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50"
                    }`}
                  >
                    {copied ? "✓ Copied!" : "📋 Copy"}
                  </button>
                  <button 
                    onClick={downloadPDF}
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-gray-50 transition-all"
                  >
                   📕 PDF
                  </button>
                  <button 
                    ...
                    disabled={loading}
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-xl text-sm font-bold transition-all"
                  >
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-gray-50/50 rounded-xl border-2 border-dashed border-gray-200">
                <div className="w-16 h-16 bg-white rounded-2xl shadow-sm border border-gray-100 flex items-center justify-center text-3xl mb-4">
                  📝
                </div>
                <h3 className="font-bold text-gray-900 mb-2">Ready to Write</h3>
