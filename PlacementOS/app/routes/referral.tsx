    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-10 relative z-20">
        ...
        {mode === "need" && (
          <div className="animate-fade-in-up">
            ...
            {/* Search Bar */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-6 mb-8 flex flex-col md:flex-row gap-4">
              <input type="text" placeholder="Company (e.g. Google)" value={searchCompany} onChange={e=>setSearchCompany(e.target.value)} className="flex-1 p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl font-medium focus:ring-2 focus:ring-rose-500"/>
              <input type="text" placeholder="Role (e.g. Frontend)" value={searchRole} onChange={e=>setSearchRole(e.target.value)} className="flex-1 p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl font-medium focus:ring-2 focus:ring-rose-500"/>
              <input type="text" placeholder="Alumni College" value={searchCollege} onChange={e=>setSearchCollege(e.target.value)} className="flex-1 p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl font-medium focus:ring-2 focus:ring-rose-500"/>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                <h2 className="font-black text-xl text-gray-900 dark:text-white mb-4 px-2">Professionals ({providers.length})</h2>
                {loading ? (
                  ...
                  providers.map(p => (
                    <div key={p._id} className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 hover:shadow-md transition-all flex flex-col md:flex-row justify-between md:items-center gap-6">
                      ...
                      <div className="flex flex-col md:items-end gap-3 text-sm">
                        <div className="flex gap-2">
                           ...
                           <span className="text-gray-600 dark:text-gray-400 font-medium text-xs max-w-[150px] truncate">{p.rolesReferredFor.join(', ')}</span>
                        </div>
                        <button 
              ...
              <div className="lg:col-span-1">
                 <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 sticky top-6 h-[600px] flex flex-col">
                   <h2 className="font-black text-xl text-gray-900 dark:text-white mb-4 pb-4 border-b border-gray-100 dark:border-gray-800">My Requests</h2>
                   <div className="flex-1 overflow-y-auto space-y-4 pr-2 custom-scrollbar">
                     {myOutgoingRequests.length === 0 ? (
                       ...
                       myOutgoingRequests.map(req => (
                         <div key={req._id} className="p-4 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950">
                           <div className="flex justify-between items-start mb-2">
                             <h4 className="font-bold text-gray-900 dark:text-white text-sm">{req.toProviderId?.company}</h4>
                           ...
                           <p className="text-xs text-gray-600 dark:text-gray-400 font-medium mb-1">Target: {req.targetRole}</p>
          ...
          <div className="animate-fade-in-up grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                <h2 className="font-black text-xl text-gray-900 dark:text-white mb-6">{isRegisteredProvider ? 'My Provider Profile' : 'Become a Referrer'}</h2>
                <form onSubmit={registerProvider} className="space-y-4">
                  <div>
                    <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">Company</label>
                    <input type="text" value={providerForm.company} onChange={e=>setProviderForm({...providerForm, company:e.target.value})} required className="w-full p-2.5 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm font-medium"/>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">Your Role</label>
                    <input type="text" value={providerForm.role} onChange={e=>setProviderForm({...providerForm, role:e.target.value})} required className="w-full p-2.5 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm font-medium"/>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">LinkedIn URL</label>
                    <input type="url" value={providerForm.linkedinUrl} onChange={e=>setProviderForm({...providerForm, linkedinUrl:e.target.value})} required className="w-full p-2.5 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm font-medium"/>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">Alumni College</label>
                    <input type="text" value={providerForm.college} onChange={e=>setProviderForm({...providerForm, college:e.target.value})} required className="w-full p-2.5 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm font-medium"/>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">Roles you refer for (CSV)</label>
                    <input type="text" value={providerForm.rolesReferredFor} onChange={e=>setProviderForm({...providerForm, rolesReferredFor:e.target.value})} className="w-full p-2.5 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg text-sm font-medium"/>
                  </div>
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800">
                    <label className="text-sm font-bold text-gray-700 dark:text-gray-300">Accepting Referrals</label>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden h-full flex flex-col min-h-[600px]">
                <div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 flex justify-between items-center">
                  <h2 className="font-black text-xl text-gray-900 dark:text-white">Incoming Requests</h2>
                  ...
                  {!isRegisteredProvider ? (
                    ...
                    <div className="space-y-4">
                      {myIncomingRequests.map(req => (
                        <div key={req._id} className="p-5 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                          {req.status !== 'Pending' && (
                          ...
                          <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-1">
                              <h3 className="text-lg font-black text-gray-900 dark:text-white mb-1">{req.requesterName}</h3>
                              <p className="text-sm font-bold text-rose-600 mb-3">Target: {req.targetRole}</p>
                              
                              <div className="bg-gray-50 dark:bg-gray-950 p-3 rounded-lg border border-gray-100 dark:border-gray-800 mb-4">
                                <p className="text-xs text-gray-500 uppercase font-black mb-1">Pitch</p>
                                <p className="text-sm text-gray-700 dark:text-gray-300 italic">"{req.message}"</p>
                              </div>
                              
                              <div className="flex gap-3 mt-2">
                                <a href={req.linkedinUrl} target="_blank" rel="noreferrer" className="text-xs font-bold text-blue-600 hover:text-blue-800 bg-blue-50 dark:bg-blue-900/20 px-3 py-1.5 rounded-lg flex items-center gap-1">🔗 LinkedIn</a>
      ...
      {showRequestModal && selectedProvider && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-lg w-full p-8 animate-fade-in-up">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-1">Ask for Referral</h2>
            <p className="text-gray-500 text-sm mb-6 font-medium">To {selectedProvider.name.split(' ')[0]} at <span className="font-bold text-gray-900 dark:text-white">{selectedProvider.company}</span></p>
            
            <form onSubmit={submitRequest} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">Target Role</label>
                <input type="text" required value={reqForm.targetRole} onChange={e=>setReqForm({...reqForm, targetRole: e.target.value})} placeholder="e.g. Frontend Engineer L4" className="w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-rose-500 font-medium"/>
              </div>
              <div className="flex gap-4">
                 <div className="flex-1">
                   <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">LinkedIn Profile</label>
                   <input type="url" required value={reqForm.linkedinUrl} onChange={e=>setReqForm({...reqForm, linkedinUrl: e.target.value})} placeholder="https://..." className="w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-rose-500 font-medium"/>
                 </div>
                 <div className="flex-1">
                   <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">Resume Link (Drive/PDF)</label>
                   <input type="url" required value={reqForm.resumeUrl} onChange={e=>setReqForm({...reqForm, resumeUrl: e.target.value})} placeholder="https://..." className="w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-rose-500 font-medium"/>
                 </div>
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">Quick Pitch (Why should they refer you?)</label>
                <textarea required value={reqForm.message} onChange={e=>setReqForm({...reqForm, message: e.target.value})} maxLength={500} placeholder="I have solved 500+ LeetCode problems and built exactly the type of system your team is hiring for..." className="w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-rose-500 font-medium h-24 resize-none"/>
