  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      ...
      <FeatureHeader
        ...
        icon="📄"
        description="Build an ATS-friendly, professional resume from scratch with intelligent AI enhancements."
        whatItDoes="This tool provides a step-by-step form to build your resume. It dynamically updates a live preview and uses AI to rewrite your bullet points for maximum impact."
        howItWorks={[
          "Fill in your personal details, education, and projects.",
          "Click '✨ Enhance' next to any description to have AI instantly rewrite it.",
          "Click 'Suggest based on XP' to auto-generate a skills list.",
          "Download the polished PDF instantly."
        ]}
        whyItMatters={[
          "A poorly formatted resume will be instantly rejected by ATS systems.",
          "AI helps you use strong action verbs and quantify achievements perfectly."
        ]}
        aiCapabilities={[
          "Context-aware bullet point rewriting.",
          "Automatic skill extraction based on work history."
        ]}
        tips={[
          "Don't lie on your resume. AI can make it sound good, but you have to defend it.",
          "Keep descriptions to 2-3 bullet points."
        ]}
        gradient="from-emerald-600 to-teal-700"
      />

      <div className="flex-1 w-full max-w-6xl mx-auto px-6 py-12 flex gap-8 flex-col lg:flex-row items-stretch relative z-10">
        ...
        <div className="flex-1 w-full lg:w-1/2 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 flex flex-col overflow-hidden">
                 ...
                 className={`whitespace-nowrap px-4 py-2 rounded-lg text-sm font-bold transition-all ${
                   step === i + 1 
                     ...
                     : step > i + 1 
                       ...
                       : "text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-900"
                 }`}
               >
                 {i + 1}. {name}
               </button>
            ...
            {step === 1 && (
              <div className="animate-fade-in space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">FULL NAME</label><input value={personal.fullName} onChange={e=>setPersonal({...personal, fullName:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all font-medium"/></div>
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">EMAIL</label><input type="email" value={personal.email} onChange={e=>setPersonal({...personal, email:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all"/></div>
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">PHONE</label><input value={personal.phone} onChange={e=>setPersonal({...personal, phone:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all"/></div>
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">LOCATION</label><input value={personal.location} onChange={e=>setPersonal({...personal, location:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all"/></div>
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">LINKEDIN URL</label><input value={personal.linkedin} onChange={e=>setPersonal({...personal, linkedin:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all"/></div>
                  <div><label className="text-xs font-bold text-gray-500 dark:text-gray-400">GITHUB URL</label><input value={personal.github} onChange={e=>setPersonal({...personal, github:e.target.value})} className="mt-1 w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all"/></div>
                </div>
              </div>
            )}
              ...
              <div className="animate-fade-in space-y-6">
                ...
                <div>
                  <input 
                    ...
                    className="w-full p-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl focus:bg-white dark:focus:bg-gray-900 dark:bg-gray-900 focus:ring-2 focus:ring-emerald-500 transition-all font-medium mb-4"
                  />
                  <div className="flex flex-wrap gap-2">
                    ...
                    {skills.length === 0 && (
                      <p className="text-sm text-gray-500 dark:text-gray-400 italic w-full text-center py-4 bg-gray-50 dark:bg-gray-950 rounded-xl border border-dashed border-gray-200 dark:border-gray-800">
          ...
          <div className="border-t border-gray-100 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-950 flex justify-between items-center rounded-b-2xl">
            <button 
              ...
              disabled={step === 1}
              className={`px-4 py-2 text-sm font-bold rounded-lg transition-colors ${step === 1 ? 'text-gray-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:bg-gray-800'}`}
            >
              ← Back
            </button>
            ...
            <button 
              onClick={() => setStep(step + 1)} 
              disabled={step === 6}
              className={`px-6 py-2 text-sm font-bold rounded-lg transition-colors ${step === 6 ? 'bg-gray-200 dark:bg-gray-800 text-gray-400' : 'bg-emerald-600 text-white shadow-md hover:bg-emerald-700'}`}
            >
              Next →
            </button>
          </div>
        ...
        <div className="flex-[1.5] bg-gray-200 dark:bg-gray-800 p-4 sm:p-8 rounded-2xl shadow-inner border border-gray-200 dark:border-gray-800 flex flex-col h-[700px] lg:h-auto lg:min-h-[800px] overflow-y-auto custom-scrollbar relative">
          ...
          <div className="w-full max-w-[800px] mx-auto bg-white dark:bg-gray-900 shadow-2xl min-h-[1056px] flex flex-col p-10 md:p-14 mb-10 transition-all font-sans">
            ...
            {experiences.some(e => e.company || e.role) && (
              <section className="mb-6">
                <h2 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest border-b border-gray-300 dark:border-gray-700 pb-1 mb-3">Experience</h2>
            ...
            {projects.some(p => p.name) && (
              <section className="mb-6">
                <h2 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest border-b border-gray-300 dark:border-gray-700 pb-1 mb-3">Projects</h2>
                <div className="space-y-4">
                  {projects.map(p => {
                    ...
                    return (
                      <div key={p.id}>
                        <div className="flex items-baseline gap-2 mb-1">
                          ...
                          {p.githubUrl && <span className="text-xs text-blue-600 dark:text-blue-400 ml-auto">{p.githubUrl}</span>}
                        </div>
                        <div className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed max-w-[90%] whitespace-pre-wrap">
                          {p.description}
                        </div>
            ...
            {educations.some(e => e.degree || e.college) && (
              <section className="mb-6">
                <h2 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest border-b border-gray-300 dark:border-gray-700 pb-1 mb-3">Education</h2>
            ...
            {skills.length > 0 && (
              <section className="mb-6">
                <h2 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest border-b border-gray-300 dark:border-gray-700 pb-1 mb-3">Skills</h2>
