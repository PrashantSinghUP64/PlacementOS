      ...
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <div className="mt-8 flex flex-col space-y-3 pt-6 border-t border-gray-800">
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full bg-white text-gray-900 font-bold p-3 rounded-xl shadow flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors disabled:opacity-50"
          >
