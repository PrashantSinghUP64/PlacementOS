...
export default function Templates() {
  ...
  const inp = "w-full p-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-violet-400 focus:outline-none font-medium";
        ...
        {!selected ? (
          <div>
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-6">
              <h2 className="text-xl font-black text-gray-900 mb-5">Choose Your Template</h2>
                  ...
                  <div key={t.id} className={`border-2 ${t.color} rounded-2xl overflow-hidden cursor-pointer hover:shadow-lg transition-all group`} onClick={() => setSelected(t.id)}>
                    ...
                    <div className="p-4 bg-gray-50 border-t border-gray-100">
                      <div className="flex items-center justify-between mb-1">
                        <h3 className="font-black text-gray-900 flex items-center gap-1">{t.icon} {t.name}</h3>
          ...
          <div>
            {/* Back + Template info */}
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 mb-5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <button onClick={() => { setSelected(null); setPreview(false); }} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl text-sm transition-colors">← Back</button>
                <div>
                  <h2 className="font-black text-gray-900">{TEMPLATES.find(t => t.id === selected)?.icon} {TEMPLATES.find(t => t.id === selected)?.name} Template</h2>
                  <p className="text-xs text-gray-500 font-medium">Fill the form below → Download PDF</p>
                </div>
              </div>
              <div className="flex gap-2">
                <button onClick={() => setPreview(!preview)} className="px-4 py-2 border border-gray-200 hover:border-violet-400 text-gray-700 font-bold rounded-xl text-sm transition-colors">{preview ? "Edit" : "Preview"}</button>
            ...
            {preview ? (
              ...
              <div className="space-y-5">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <h3 className="font-black text-gray-900 mb-4">Personal Info</h3>
                ...
                {/* Summary */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <h3 className="font-black text-gray-900 mb-4">Professional Summary</h3>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-black text-gray-900">Education</h3>
                  ...
                  {data.education.map((e, i) => (
                    <div key={i} className="grid md:grid-cols-2 gap-3 mb-3 p-3 bg-gray-50 rounded-xl">
                ...
                {/* Skills */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <h3 className="font-black text-gray-900 mb-4">Skills</h3>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-black text-gray-900">Projects</h3>
                  ...
                  {data.projects.map((p, i) => (
                    <div key={i} className="p-3 bg-gray-50 rounded-xl mb-3">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-black text-gray-900">Experience (Internship / Part-time)</h3>
                ...
                {/* Achievements */}
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  <h3 className="font-black text-gray-900 mb-4">Achievements & Certifications</h3>
                ...
                <div className="flex justify-end gap-3">
                  <button onClick={() => setPreview(true)} className="px-6 py-3 border border-gray-200 hover:border-violet-400 text-gray-700 font-bold rounded-xl transition-colors">Preview Resume 👁️</button>
